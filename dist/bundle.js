...
/***/ function(module, exports, __webpack_require__) {
	...
	_googleMaps2.default.load(function (google) {
	  ...
	  var options = {
	    zoom: 16,
	    center: new (Function.prototype.bind.apply(g.maps.LatLng, [null].concat(_toConsumableArray(locs.pts.coordinates))))(),
	    mapTypeId: g.maps.MapTypeId.ROADMAP,
	    disableDefaultUI: true
	  };
	
	  map = new g.maps.Map((0, _jquery2.default)('#map').get(0), options);
	
	  Object.keys(locs).map(function (title, i) {
	    var l = locs[title];
	    ...
	    var _l$coordinates = _slicedToArray(l.coordinates, 2);
	
	    var lat = _l$coordinates[0];
	    var lng = _l$coordinates[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
	  var $container = (0, _jquery2.default)('.el-bars.container');
	  $container.scroll(function () {
	    var locKeys = Object.keys(_map.locs);
	
	    var scrollingDown = $container.scrollTop() > prevScrollPos;
	    ...
	    locKeys.map(function (l) {
	      ...
	      var offset = (0, _jquery2.default)('.card.' + l, $container).offset().top;
